<template>
    ...
    <div class="container mx-auto flex flex-col p-3">
        ...
        <div class="flex py-2">
            <div class="w-1/5 p-2">
                <img :src="`/${selectedImage}`" alt="" class="w-full h-64">
            </div>
            <div class="w-2/5 p-2 flex flex-col">
                ...
                <div class="flex">
                    <div @mouseover="selectVariant(index)" class="h-16 w-16 p-1 m-1 border-2 border-red-900" v-for="( variant,index ) in product.variants" :key="index">
                        <img :src="`/${variant.photos[0]}`" alt="" class="w-full h-full">
                    </div>
        ...
        <div class="mt-16">
            <tabs>
                <tab name="Description" :selected="true" class="">
                ...
                <tab name="What's include in the box ?">
...
export default {
    ...
    computed: {
        ...
        selectedImage(){
              return this.selected_variant.photos[0];
        }
    },
    watch: {
        id() {
